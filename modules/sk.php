...
sendMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: SK KEY CHK%0A[ϟ] SK KEY: <code>$sec</code>%0A[ϟ] STATUS: DEAD KEY❌%0A[ϟ] RESPONSE: <code>$msg</code>%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>%0A", $message_id);
...
sendMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: SK KEY CHK%0A[ϟ] SK KEY: <code>$sec</code>%0A[ϟ] STATUS: MISSING KEY❌%0A[ϟ] RESPONSE: <code>$msg</code>%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>%0A", $message_id);
}
elseif ((strpos($result, 'rate_limit')) || (strpos($result, 'rate_limit'))){
sendMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: SK KEY CHK%0A[ϟ] SK KEY: <code>$sec</code>%0A[ϟ] STATUS: VALID SK KEY✅%0A[ϟ] RESPONSE: RATE LIMIT ⚠️.%0A[ϟ] CURRENCY: $curr%0A[ϟ] BALANCE: $balance%0A[ϟ] PENDING AMOUNT: $pending%0A[ϟ] CARDS PROCESSED: $pending%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>%0A", $message_id);
}  
elseif ((strpos($result, 'testmode_charges_only')) || (strpos($result, 'test_mode_live_card'))){
sendMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: SK KEY CHK%0A[ϟ] SK KEY: <code>$sec</code>%0A[ϟ] STATUS: DEAD KEY❌%0A[ϟ] RESPONSE: <code>$msg</code>%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>", $message_id);
}else{
