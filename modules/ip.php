...
$ip = substr($message, 4);
    ...
    $sendmes = "https://api.telegram.org/bot$botToken/sendMessage?chat_id=".$chatId."&text=<b>CAT EVIL CORP ✅- Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] IP: ".$ip."%0A[ϟ] STATUS: CHECKING IP,PLEASE WAIT%0A━━━━━━━━━━━━━</b>&reply_to_message_id=".$message_id."&parse_mode=HTML";
